...
{
    static const float background_color[] = {0.49f, 0.73f, 0.92f, 1.0f};    // blue
    glClearBufferfv(GL_COLOR, 0, background_color);
    glClear(GL_DEPTH_BUFFER_BIT);
    ContainerBox::draw();   // draw all boxes
}
...
void updateFPS(GLFWwindow *window)
{
    ...
    if (dur.count() > 1000)
    {
        std::string title_tmp = title + " [FPS: " + std::to_string(frames) + "]";
        glfwSetWindowTitle(window, title_tmp.c_str());
        tp1 = tp2;
        frames = 0;
    }
}
